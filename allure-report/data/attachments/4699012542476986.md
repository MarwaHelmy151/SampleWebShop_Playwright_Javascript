...
- Name: 6-CustomerInfo.spec.js >> User can change password successfully
- Location: tests\6-CustomerInfo.spec.js:4:1
...
Locator: locator('div[class=\'header-links\'] a[href=\'/customer/info\']')
Expected: "MariamTester@gmail.com"
Error: element(s) not found

Call log:
  - Expect "toHaveText" with timeout 40000ms
  - waiting for locator('div[class=\'header-links\'] a[href=\'/customer/info\']')
            ...
            - generic [ref=e92]:
              ...
              - generic [ref=e96]:
                - generic [ref=e98]:
                  ...
                  - list [ref=e99]:
                    - listitem [ref=e100]: The credentials provided are incorrect
                - generic [ref=e101]:
                  - generic [ref=e102]: "Email:"
                  - textbox "Email:" [active] [ref=e103]: MariamTester@gmail.com
                - generic [ref=e104]:
...
```ts
  ...
  3  | 
  4  | test('User can change password successfully', async ({ page }) => {
  5  |     const email = "MariamTester@gmail.com"
  6  |     const password = "12345678"
  7  |     const newPassword = "123456"
  8  | 
  9  |     // valid login
  ...
  15 |     await loginpage.validlogin(email, password)
> 16 |     await expect(loginpage.customerinfopage).toHaveText(email)
     |                                              ^ Error: expect(locator).toHaveText(expected) failed
  17 | 
  18 | 
  19 |     // navigate to customerinfo page
  20 |     await loginpage.openCustomerInfoPage()
  21 | 
  22 |     // Change password
  23 |     const customerinfopage = pommanager.getcustomerInfopage()
  24 |     customerinfopage.changePassword(password, newPassword)
  25 |     await expect(customerinfopage.successMessage).toHaveText("Password was changed")
  26 |     await loginpage.logout();
  27 | 
  28 |     // Login again successfully with new credentials
  29 |     await homepage.openLoginPage()
  30 |     await loginpage.validlogin(email, newPassword)
  31 |     await expect(loginpage.customerinfopage).toHaveText(email)
  32 | 
  33 | })
```